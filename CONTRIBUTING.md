...
2. In your clone of github.com/hongrich/revel, add your fork as a remote.
3. Push to your fork to prepare a pull request.

Here is the command line: 
```
$ cd $GOPATH/src/github.com/hongrich/revel              # Change directory to revel repo
...
Refer to the
[Travis configuration](https://github.com/hongrich/revel/blob/master/.travis.yml)
...
[issues](https://github.com/hongrich/revel/issues?labels=contributor+ready&page=1&state=open).
